...
from lipaiapi.utility.common import dict_key, update_dict, generate_phone_number, generate_customer_name
...
class CompanyCustomerInfo(Key):
    ...
    def customer_info_fields(self):
        data = {"model": lipaiapi.model.base_view_model, "resModel": lipaiapi.model.customer_info_model,
                "kwargs": {"context": {"lang": "zh_CN"}, "views": [[94, "tree"], [95, "form"], [96, "search"]]}}
    ...
    def customer_info_default_get(self):
        data = {"model": lipaiapi.model.customer_info_model,
                "fields": self.customer_info_fields(), "context": {"default_type": 1}}
    ...
    def company_customer_process(self):
